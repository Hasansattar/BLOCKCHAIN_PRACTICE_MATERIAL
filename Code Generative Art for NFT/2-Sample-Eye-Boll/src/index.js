...
const {layers,width,height} =require("./input/config.js");       // 11 that comes into config.js file
...
const drawLayer = async () => {                                    //5 draw the image
  ...
  ctx.drawImage(image, 0, 0, width, height);              // 6 ctx.drawImage(img,x,y,width,height);  
